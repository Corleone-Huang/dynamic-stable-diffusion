...
# apply dynamic semantic evolution
class DynamicUNetModel(nn.Module):
    ...
    def __init__(
        ...
        self.semantic_evolution_module = instantiate_from_config(evolution_module_config)
    ...
    def forward(self, x, timesteps=None, context=None, y=None,**kwargs):
        ...
        # update context 
        context = self.semantic_evolution_module(x=x, timesteps=timesteps, context=context)
